package org.typeutils.typewrapper;
...
public class SingleTypeWrapper extends TypeWrapper implements GenericDeclaration, AnnotatedElement {
	...
	public Type asType(Type targetType) {
		...
		if(isWeakAssignableFrom(targetType))
			type = TypeUtils.bindTypeGivenAncestor(this, targetTypeWrapper);
		else
			type = TypeUtils.bindTypeGivenDescendant(targetTypeWrapper, this); //will throw an IncompatibleTypesException if !targetTypeWrapper.isWeakAssignableFrom(this)
		return type;
	}
